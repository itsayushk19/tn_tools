    ...
    <>
      <div className="grid lg:grid-flow-col">
        ...
        <div className="flex flex-col justify-evenly content-center items-center">
          <button
            className={`tn_button tn_button_medium tn_button_primary ripple ripple ${isInputEmpty ? 'tn_button_disabled' : ''}`}
      ...
      >
        <div className="colorCard form__field form__field__med form__field__no__margin ">
          <div
            className="colorPane"
            style={{
              background: colorCodes.hex ? (colorCodes.hex.startsWith("#") ? colorCodes.hex : `#${colorCodes.hex}`) : undefined,
            }}
          >
            {!colorCodes.hex && (
          ...
          <div className="colorInfo">
            {!colorCodes.hex ? (
              ...
              <div className="grid-container">
                ...
                <div className="colorMetaValue" onClick={() => handleCopy(`#${colorCodes.hex}`)}>
                  {colorCodes.hex}
                </div>
                <div>
                  <strong className="colorMeta">RGBA</strong>
                </div>
                <div className="colorMetaValue" onClick={() => handleCopy(colorCodes.rgba)}>
                  {colorCodes.rgba}
                </div>
                <div>
                  <strong className="colorMeta">HSLA</strong>
                </div>
                <div className="colorMetaValue" onClick={() => handleCopy(colorCodes.hsla)}>
                  {colorCodes.hsla}
                </div>
                <div>
                  <strong className="colorMeta">Type</strong>
                </div>
                <div className="colorMetaValue" onClick={() => handleCopy(colorCodes.brightness)}>
